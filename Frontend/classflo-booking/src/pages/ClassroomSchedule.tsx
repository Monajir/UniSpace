...
import { useClassrooms } from "@/hooks/useClassrooms";
import { useBookings } from "@/hooks/useBookings";
import { BOOKING_SLOTS, BookingSlot } from "@/lib/bookingSlots";
          ...
          <Card ref={calendarRef} className="glass shadow-elegant">
            ...
            <CardContent>
              ...
              <div className="text-center mt-4 text-sm text-muted-foreground">
                <p>
                  {canBook
                    ? "Click on available time slots to book this classroom"
                    : "Schedule is read-only. Booking is available to class representatives."}
                </p>
              </div>
            </CardContent>
          </Card>
