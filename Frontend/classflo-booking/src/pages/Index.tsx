      ...
      <div className="relative z-10">
        ...
        <section ref={heroRef} className="pt-32 pb-20 px-4">
          <div className="container mx-auto text-center">
            <h1 className="hero-title hero-wordmark text-6xl md:text-7xl font-bold mb-6">
            ...
            <div className="hero-cta space-y-8">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                <Button
                  variant="outline"
                  size="lg"
                  className="glass-action hover-scale"
                  onClick={() => {
        ...
        <section ref={featuresRef} className="py-20 px-4">
          <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="feature-card glass-panel p-8 rounded-2xl hover-lift">
